    ...
    return (
        <section className='flex flex-col px-5 py-5 mx-auto lg:flex-row lg:items-center lg:gap-x-10'>
            <div className='mt-10 lg:w-1/2 md:max-w-full'>
                <h1 className='font-roboto text-3xl text-center lg:text-left  lg:max-w-[540px] font-bold xl:text-5xl lg:text-4xl text-dark-soft md:text-5xl'>
                    Read the most interesting articles
                </h1>
                <p className='text-dark-light mt-4 text-center md:text-xl lg:text-left lg:text-base'>
            ...
            <div className='mt-10 lg:w-1/2 md:flex md:items-center md:justify-center'>
                <img
                    ...
                    className='w-full max-w-[700px] h-auto object-contain hidden lg:block' 
                    src={image1}
                />
            </div>
        </section>
