    ...
    return (
        <section className='flex flex-col px-5 py-5 mx-auto lg:flex-row lg:items-center lg:gap-x-10'>
            <div className='mt-10 lg:w-1/2 md:max-w-full'>
                <h1 className='font-roboto text-3xl text-center lg:text-left lg:max-w-[540px] font-bold md:text-4xl text-dark-soft md:text-5xl'>
                ...
                <div className='flex flex-col gap-y-2.5 mt-10 relative '>
                    <div className='relative'>
                        ...
                        <input
                            type='text'
                            className='placeholder:font-bold font-semibold bg-white  text-dark-soft placeholder:text-[#959EAD] rounded-lg pl-12 pr-3 w-full md:w-full py-3 focus:outline-none shadow-[rgba(13,_38,_76,_0.19)_0px_9px_20px] md:py-4'
